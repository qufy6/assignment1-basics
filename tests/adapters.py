...
def run_multihead_self_attention(
    ...
    mha.W_Q.weight.data.copy_(q_proj_weight.T)
    mha.W_K.weight.data.copy_(k_proj_weight.T)
    mha.W_V.weight.data.copy_(v_proj_weight.T)
    mha.W_O.weight.data.copy_(o_proj_weight.T)
...
def run_multihead_self_attention_with_rope(
    ...
    # Assign the weights to the MultiHeadAttention instance
    mha.W_Q.weight.data.copy_(q_proj_weight.T)
    mha.W_K.weight.data.copy_(k_proj_weight.T)
    mha.W_V.weight.data.copy_(v_proj_weight.T)
    mha.W_O.weight.data.copy_(o_proj_weight.T)
    ...
    return mha(in_features)  # type: ignore[return-value]
    raise NotImplementedError
